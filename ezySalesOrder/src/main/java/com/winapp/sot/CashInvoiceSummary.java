...
public class CashInvoiceSummary extends SherlockFragmentActivity implements SlideMenuFragment.MenuClickInterFace,Constants, GoogleApiClient.ConnectionCallbacks,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Mint.initAndStartSession(CashInvoiceSummary.this, "29088aa0");
		...
		txt.setText("Cash Invoice Summary");
		...
		offlineDatabase = new OfflineDatabase(CashInvoiceSummary.this);
		offlineCommon = new OfflineCommon(CashInvoiceSummary.this);
		checkOffline = OfflineCommon.isConnected(CashInvoiceSummary.this);
		OfflineDatabase.init(CashInvoiceSummary.this);
		new OfflineSalesOrderWebService(CashInvoiceSummary.this);
		offlinecustomerSynch = new OfflineCustomerSync(CashInvoiceSummary.this);
		...
		sqldb = new SOTDatabase(CashInvoiceSummary.this);
		FWMSSettingsDatabase.init(CashInvoiceSummary.this);
		...
		helper = new UIHelper(CashInvoiceSummary.this);
		SOTDatabase.init(CashInvoiceSummary.this);
...
//					haveBatchOnStockOut="True";
					...
					if (haveBatchOnStockOut != null
						...
						if (haveBatchOnStockOut.matches("True")) {
							...
							new SoapAccessTask(CashInvoiceSummary.this, valid_url,
...
//						double subTotal = Double.parseDouble(sub);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v, int arg2,
				...
				if (appType.matches("W")) {
					...
					// {
					Intent i = new Intent(CashInvoiceSummary.this, AddBarcode.class);
					...
					startActivity(i);
					CashInvoiceSummary.this.finish();
				} else {
		...
		barcode_edit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(CashInvoiceSummary.this,
...
//					String taxValue = SalesOrderSetGet.getTaxValue();
					...
					if (billCursor != null && billCursor.getCount() > 0) {
						...
						Log.d("taxcalc billDiscount", "" + billDiscount);
...
//				haveBatchOnStockOut="True";
	...
	private class AsyncCallWSSummary extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			SOResultArr.clear();
			spinnerLayout = new LinearLayout(CashInvoiceSummary.this);
			...
			progressBar = new ProgressBar(CashInvoiceSummary.this);
				...
				if (onlineMode.matches("True")) {
					if (checkOffline == true) {
						...
						if (dialogStatus.matches("true")) {
							...
							SOResultArr = OfflineSalesOrderWebService
									.summaryInvoiceServiceOffline(
											"fncSaveCashInvoice", discnt, subTot,
											totTax, netTot,
						...
						SOResultArr = SOTSummaryWebService
								.summaryInvoiceService("fncSaveCashInvoice",
										discnt, subTot, totTax, netTot,
										Double.toString(tota), slNo, SoNo,
										DoNo, invoiceNumber, username,"");
					...
					SOResultArr = OfflineSalesOrderWebService
							.summaryInvoiceServiceOffline("fncSaveCashInvoice",
									discnt, subTot, totTax, netTot,
		...
		protected void onPostExecute(Void result) {
			...
			if (summaryResult.matches("failed")) {
				...
				Toast.makeText(CashInvoiceSummary.this, "Failed",
				...
				Toast.makeText(CashInvoiceSummary.this, "Saved Successfully",
						Toast.LENGTH_SHORT).show();
			...
			enableViews(slsummary_layout, true);
				...
				if (emailIschecked == true) {
					...
					if(!customeremail.matches("")){
						...
						Toast.makeText(CashInvoiceSummary.this,"Customer has no email address",Toast.LENGTH_LONG).show();
					}
					...
					if (FWMSSettingsDatabase
						...
						if (cash_checkbox.isChecked()) {
							if (ReceiptNo.matches("null")
									|| ReceiptNo.matches("")) {
								Toast.makeText(CashInvoiceSummary.this,
	...
	public void clearView() {
		 ...
		 */
		if (header.matches("InvoiceHeader")) {
			intent = new Intent(CashInvoiceSummary.this, CashInvoiceHeader.class);
		} else if (header.matches("DeliveryOrderHeader")) {
			intent = new Intent(CashInvoiceSummary.this, DeliveryOrderHeader.class);
		} else if (header.matches("SalesOrderHeader")) {
			intent = new Intent(CashInvoiceSummary.this, SalesOrderHeader.class);
		} else if (header.matches("CustomerHeader")) {
			intent = new Intent(CashInvoiceSummary.this, CustomerListActivity.class);
		} else if (header.matches("RouteHeader")) {
			intent = new Intent(CashInvoiceSummary.this, RouteHeader.class);
		} else {
			intent = new Intent(CashInvoiceSummary.this, LandingActivity.class);
		}
...
//				b.recycle();
	...
	public boolean onContextItemSelected(android.view.MenuItem item) {
		...
		if (item.getTitle() == "Edit Batch") {
				...
				if (haveBatch.matches("True") || haveExpiry.matches("True")) {
					...
					hm.put("sm_subTotal_inclusive", sm_subTotal_inclusive);
						...
						invoiceBatchDialog.initiateBatchPopupWindow(
								CashInvoiceSummary.this, id, sno, haveBatch,
			...
			if (screenInches < 7) {
				...
				builder = new AlertDialog.Builder(CashInvoiceSummary.this);
				builder.setTitle(((TextView) info.targetView
						.findViewById(R.id.ss_prodcode)).getText().toString());
				LayoutInflater adbInflater = LayoutInflater
						.from(CashInvoiceSummary.this);
			...
			if (cursor != null && cursor.getCount() > 0) {
				...
				Toast.makeText(CashInvoiceSummary.this, "Deleted",
						Toast.LENGTH_LONG).show();
			} else {
				sm_header_layout.setVisibility(View.GONE);
				save.setVisibility(View.INVISIBLE);
	...
	public void onContextMenuClosed(Menu menu) {
		...
		if(contextmenu_click.equalsIgnoreCase("Edit") || contextmenu_click.equalsIgnoreCase("Delete")) {
			...
			Log.d("closed not matches","not "+contextmenu_click);
			String billdesc = strValidate(CustomerSetterGetter.getBillDiscount());
			if (!billdesc.matches("")) {
				double dbilldisc = Double.parseDouble(billdesc);
				if (dbilldisc > 0) {
...
//												}
	...
	private class AsyncCallWSEmail extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if(response.equalsIgnoreCase("True")){
				Toast.makeText(CashInvoiceSummary.this,"Email sent successfully",Toast.LENGTH_LONG).show();
			}else{
				Toast.makeText(CashInvoiceSummary.this,"Failed to sent email",Toast.LENGTH_LONG).show();
			}
	...
	private void print() throws IOException {
		...
		try {
			...
			Printer printer = new Printer(CashInvoiceSummary.this, macaddress);
			printer.setOnCompletionListener(new Printer.OnCompletionListener() {
				...
				public void onCompleted() {
					...
					if (mDeliveryCheckBox.isChecked()) {
						Printer printer1 = new Printer(CashInvoiceSummary.this,
								macaddress);
						printer1.setOnCompletionListener(new Printer.OnCompletionListener() {
							...
							public void onCompleted() {
								...
								finish();
								if (header.matches("InvoiceHeader")) {
									intent = new Intent(CashInvoiceSummary.this,
											CashInvoiceHeader.class);
			...
			if (cash_checkbox.isChecked()) {
				...
				if (enableprint.isChecked()) {
						printer.printInvoice(summaryResult, soDate, customerCode,
								...
								gnrlStngs, nofcopies, product_batchArr, footerArr,"fncGetCashInvoiceHeader","","","");
				...
				helper.showProgressDialog(CashInvoiceSummary.this.getString(R.string.print),
						CashInvoiceSummary.this.getString(R.string.creating_file_for_printing));
				if (BluetoothAdapter.checkBluetoothAddress(macAddress))
				{
					BluetoothDevice device = GlobalData.mBluetoothAdapter.getRemoteDevice(macAddress);
					// Attempt to connect to the device
				...
				helper.dismissProgressDialog();
				try {
					final CubePrint print = new CubePrint(CashInvoiceSummary.this,macaddress);
				...
				helper.dismissProgressDialog();
				PrinterZPL printer = new PrinterZPL(CashInvoiceSummary.this, macaddress);
				printer.setOnCompletionListener(new PrinterZPL.OnCompletionListener() {
					...
					public void onCompleted() {
						...
						if (mDeliveryCheckBox.isChecked()) {
							PrinterZPL printer1 = new PrinterZPL(CashInvoiceSummary.this,
									macaddress);
		...
		protected ArrayList<String> doInBackground(Void... arg0) {
			...
			for (int i = 0; i < lengJsonArr; i++) {
				...
				try {
					...
					String invoiceno = jsonChildNode.optString("CashTranNo")
							.toString();
...
//					showcartonloose = "";
					...
					if (showcartonloose.equalsIgnoreCase("1")) {
						jsonString = SalesOrderWebService.getSODetail(hm,
								"fncGetCashInvoiceDetailWithCarton");

					} else {
						jsonString = SalesOrderWebService.getSODetail(hm,
								"fncGetCashInvoiceDetail");
					}
...
//						.show();
	...
	public void reconnectDialog(String msg){
		...
		final String macaddress = FWMSSettingsDatabase.getPrinterAddress();
		final Dialog dialog = new Dialog(CashInvoiceSummary.this);
	...
	public void print4Inch(){
		...
		final String customerCode = SalesOrderSetGet.getCustomercode();
		 final String customerName = SalesOrderSetGet.getCustomername();
		final String soDate = SalesOrderSetGet.getSaleorderdate();
		CubePrint mPrintCube = new CubePrint(CashInvoiceSummary.this,FWMSSettingsDatabase.getPrinterAddress());
		mPrintCube.setOnCompletedListener(new CubePrint.OnCompletedListener() {
			...
			public void onCompleted() {
				...
				if (mDeliveryCheckBox.isChecked())
				{
					CubePrint mPrintCube1 = new CubePrint(CashInvoiceSummary.this,FWMSSettingsDatabase.getPrinterAddress());
...
//				mDeliveryCheckBox.setChecked(false);
	...
	public void onBackPressed() {
		sm_billDisc.setText("");
		sm_billDiscPercentage.setText("");
		Intent i = new Intent(CashInvoiceSummary.this, CashInvoiceAddProduct.class);
		startActivity(i);
		CashInvoiceSummary.this.finish();
	}
