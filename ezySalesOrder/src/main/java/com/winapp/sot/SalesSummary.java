...
public class SalesSummary extends SherlockFragmentActivity implements
...
ColorAttributeDialog.ProductModifierDialogListener{
	...
	LinearLayout sm_header_layout, slsummary_layout, noofprint_layout,
			...
			sm_lqty_layout, sm_qty_layout, sm_foc_layout, sm_price_layout,sm_cprice_layout,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Mint.initAndStartSession(SalesSummary.this, "29088aa0");
		...
		txt.setText("Sales Order Summary");
		...
		offlineDatabase = new OfflineDatabase(SalesSummary.this);
		offlineCommon = new OfflineCommon(SalesSummary.this);
		checkOffline = OfflineCommon.isConnected(SalesSummary.this);
		OfflineDatabase.init(SalesSummary.this);
		new OfflineSalesOrderWebService(SalesSummary.this);
		offlinecustomerSynch = new OfflineCustomerSync(SalesSummary.this);
		...
		FWMSSettingsDatabase.init(SalesSummary.this);
		valid_url = FWMSSettingsDatabase.getUrl();
		new SOTSummaryWebService(valid_url);
		helper = new UIHelper(SalesSummary.this);
...
//					SalesOrderSetGet.setTaxValue(TaxPerc);
					...
					Log.d("Qty", "" + dqty);
					Log.d("focQty", "" + focQty);
					Log.d("pcsPerCartonrice", "" + dpcsPerCarton);
...
//						double subTotal = Double.parseDouble(sub);
		...
		signature.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				Intent i = new Intent(SalesSummary.this, CaptureSignature.class);
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.d("TotalValueCheck","-->"+subTot+","+totTax+","+netTot+","+tot);
...
//					String taxValue = SalesOrderSetGet.getTaxValue();
	...
	private class ProductListAdapter extends ResourceCursorAdapter {
		...
		public void bindView(final View view, final Context context, Cursor cursor) {
			...
			Log.d("COLUMN_PRODUCT_PRICETXT","-->"+cursor.getString(cursor
							.getColumnIndex(SOTDatabase.COLUMN_PRODUCT_PRICE)));
	...
	private class AsyncCallWSSummary extends AsyncTask<Void, Void, Void> {
			...
			try {
				...
				if (onlineMode.matches("True")) {
					if (checkOffline == true) { // temp_offline
						...
						Log.d("subTot&totTax","-->"+totTax+","+subTot+","+netTot+","+tot);
		...
		protected void onPostExecute(Void result) {
			...
			if (summaryResult.matches("failed")) {
				Toast.makeText(SalesSummary.this, "Failed", Toast.LENGTH_SHORT)
						.show();
			} else {
...
//                Log.d("pathfind",mCurrentgetPath);
				...
				Toast.makeText(SalesSummary.this, "Saved Successfully",
	...
	public void clearView() {
		...
		if (header.matches("SalesOrderHeader")) {
			intent = new Intent(SalesSummary.this, SalesOrderHeader.class);
		} else if (header.matches("CustomerHeader")) {
			intent = new Intent(SalesSummary.this, CustomerListActivity.class);
		} else if (header.matches("RouteHeader")) {
			intent = new Intent(SalesSummary.this, RouteHeader.class);
		} else {
			intent = new Intent(SalesSummary.this, LandingActivity.class);
		}
...
//				b.recycle();
		...
		if (item.getTitle() == "Edit") {
			...
			try {
				...
				productModifierDialog.setAttributeArr(
						SalesSummary.this, sno, name, strProdCode, mDistinctColorArr, sizearrvalues,slid,screenInches);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog,
						...
						if (cursor != null && cursor.getCount() > 0) {
							...
							Toast.makeText(SalesSummary.this, "No data found",
									Toast.LENGTH_SHORT).show();
						}
					}
				});
	...
	private void print() throws IOException {
		...
		try {
			Printer printer = new Printer(SalesSummary.this, macaddress);
			printer.setOnCompletionListener(new Printer.OnCompletionListener() {
				...
				public void onCompleted() {
					 ...
					 */
					if (header.matches("SalesOrderHeader")) {
						intent = new Intent(SalesSummary.this,
								SalesOrderHeader.class);
					} else if (header.matches("CustomerHeader")) {
						intent = new Intent(SalesSummary.this,
	...
	public void navigate() {
		...
		if (RowItem.isAfterPrint() == true) {
			...
			Toast.makeText(SalesSummary.this, "Not navigated",
					Toast.LENGTH_SHORT).show();
		}
...
//		String internetStatus = "";
	...
	public void loadprogress() {
		spinnerLayout = new LinearLayout(SalesSummary.this);
		...
		progressBar = new ProgressBar(SalesSummary.this);
