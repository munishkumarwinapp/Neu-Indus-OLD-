...
public class CaptureSignature extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		helper = new UIHelper(CaptureSignature.this);
		...
		mGetSign.setOnClickListener(new OnClickListener() {
			...
			//	helper.updateProgressDialog("please wait");
				
			//	Bundle b = new Bundle();
				// b.putString("status", "done");
			//	b.putParcelable("status", mBitmap);
		...
		mCancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				/*
				 * Log.v("log_tag", "Panel Canceled"); Bundle b = new Bundle();
				 * b.putString("status", "cancel"); Intent intent = new
				 * Intent(); intent.putExtras(b); setResult(RESULT_OK,intent);
				 * finish();
				 */
				// Intent i = new Intent(CaptureSignature.this,
	 ...
	 * 
	 * boolean error = false; String errorMessage = "";
	 * 
	 * 
	 * if(yourName.getText().toString().equalsIgnoreCase("")){ errorMessage =
	 * errorMessage + "Please enter your Name\n"; error = true; }
	 * 
	 * if(error){ Toast toast = Toast.makeText(this, errorMessage,
	 * Toast.LENGTH_SHORT); toast.setGravity(Gravity.TOP, 105, 50);
	 * toast.show(); }
	 * 
	 * return error; }
	 */
	...
	public class signature extends View {
		...
		public void save(View v) {
			...
			try {
				...
				Intent intent = new Intent();
				intent.putExtra("status",bitMapData);
				setResult(RESULT_OK, intent);
				finish();
				
				//String encoded = Base64.encodeToString(bitMapData,Base64.DEFAULT);
				//Log.d("encoded", encoded);//				
				//SOTDatabase.init(CaptureSignature.this);
				
				
//				SOTDatabase.storeImage(1, encoded, "");
//				String img = SOTDatabase.getImage();
//				Log.d("Capture Image", img);
