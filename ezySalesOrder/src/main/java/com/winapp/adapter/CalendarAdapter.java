...
public class CalendarAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) { // if it's not recycled, initialize some
			...
			v = mInflater.inflate(R.layout.calendar_item, parent,false);
		...
		if (dayString.get(position).equals(curentDateString)) {
			...
			v.setBackgroundResource(R.drawable.cal_listitem_background);
		}
	...
	public View setSelected(View view) {
		if (previousView != null) {
			previousView.setBackgroundResource(R.drawable.cal_listitem_background);
		}
		previousView = view;
		view.setBackgroundResource(R.mipmap.date_pressed);
		return view;
	}
